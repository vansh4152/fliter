...
async def search(bot, message):
    ...
    if message.text.startswith("/"):
       return    
    query   = message.text 
    head    = "<u>Here is the results 👇\n\nPowered by</u> <b><I>@vip_bro10</I></b>\n\n"
    results = ""
    try:
       ...
       if bool(results)==False:
          ...
          msg = await message.reply_photo(photo="https://graph.org/file/649f41229f722ff7b5ff7.jpg",
...
async def recheck(bot, update):
    ...
    m=await update.message.edit("Movie की स्पेलिंग सही लेखा करो भाई ( Search (सर्च) कर रहा हूं Ruko (रुको)")
